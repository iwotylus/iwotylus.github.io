...
<!--excerpt.start-->
[Active](https://www.hackthebox.com/machines/Active) is an easy difficulty box. We enumerate SMB shares using null authentication to locate a <mark>Groups.xml</mark> file. This file contains Group Policy Preferenes (GPP) credentials, which we leverage to perform a Kerberoasting attack.
<!--excerpt.end-->
...
822711bcc4387df8aa49b15e842fd34d
{% endhighlight %}
